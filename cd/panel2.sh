...
# Fixed admin password (same as DB for simplicity - change if desired)
ADMIN_PASS="youPassword"
...
# Automatically create initial admin user (customize flags below if needed)
progress "Creating initial admin user..."
...
echo -e "${GLOW}${BOLD}╚══════════════════════════════════════════════════════════╝${RESET}\n"
echo -e "${YELLOW}${BOLD}🚀 Admin Login Credentials (SAVE THESE!)${RESET}"
echo -e " ${BOLD}Email:${RESET} ${WHITE}admin@${DOMAIN}${RESET}"
echo -e " ${BOLD}Username:${RESET} ${WHITE}admin${RESET}"
echo -e " ${BOLD}Password:${RESET} ${WHITE}youPassword${RESET}\n"
echo -e "${PURPLE}${BOLD}🔐 Database Credentials${RESET}"
